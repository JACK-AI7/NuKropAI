...
class WeatherService {
    static async getWeather(lat, lon) {
        try {
            ...
            const response = await axiosInstance.get(`https://api.open-meteo.com/v1/forecast?latitude=${lat}&longitude=${lon}&current_weather=true&hourly=temperature_2m,relative_humidity_2m,wind_speed_10m&daily=temperature_2m_max,precipitation_probability_max&timezone=auto`, { timeout: 10000 });
